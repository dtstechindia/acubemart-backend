...
const addNewProduct = async (req, res, next) => {
    const { name, price, description, stock, category, element, brand, model, type, status, additionalInfo, barcode, sku, sp, video, codCharges, discount, deliveryCharges } = req.body;
...
const getAllPublishedProducts = async (req, res, next) => {
    try {
        ...
        .populate({ path: "variants", select: "name value _id", strictPopulate: false })
        .populate({ path: "featuredImage", select: "url _id", strictPopulate: false  });
